...
- New project: `node v2/scripts/scaffold.mjs init <target> --api=rest --db=pg`
- Add a module: `node v2/scripts/scaffold.mjs add auth-jwt <target>`
- List modules: `node v2/scripts/scaffold.mjs list`
